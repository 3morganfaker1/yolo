                        ...
                        <div class="result-content">
                            ...
                            <el-card shadow="never" class="info-card">
                                <div class="info-item">
                                    ...
                                    <div class="info-value highlight" style="text-align:left;">
                                        <template v-if="labelCount.length">
                                            <div v-for="([label, count]) in labelCount" :key="label" style="margin-bottom:2px;">
                                                {{ label }}：{{ count }}个
                                            </div>
                                        </template>
                                        <template v-else>
...
const labelCount = computed(() => {
    ...
    const map = new Map();
    arr.forEach((l: string) => map.set(l, (map.get(l) || 0) + 1));
...
const confidenceStats = computed(() => {
    ...
    let nums = arr.map((x: any) => parseFloat(x));
