...
if __name__ == "__main__":
    # 初始化实例
    chat = ChatAPI(
        deepseek_api_key="sk-5c832673956a47cfa43af19b64aa2508",
        qwen_api_key="sk-cxnqlvtvddxtmuyqykqhlfyyqlpwiupvnbzfqbxtlzovfuph"
    )

    # 构造通用消息
    messages = [
        {"role": "user", "content": "我用yolo初步检测学生课堂行为"}
    ]
